    ...
    <div class="header--wrapper">
        <div class="header--title">
            <h2><?php
                    ...
                    if (isset($_GET['name']) && isset($_GET['admin_num'])) {
                        $admin_name = htmlspecialchars($_GET['name']);
                        echo "<h1> $admin_name!</h1>";
                    } else {
                        echo "<h1>Welcome!</h1>";
                    }
                    ?></h2>
...
function getData($sql){
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            <td>
            <form method="POST" action="remove_student.php" onsubmit="return confirm(\'Are you sure you want to remove this student?\');">
